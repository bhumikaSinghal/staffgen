...
/**
 * The Class BassStaff represents the Bass Staff.
 */
public class BassStaff implements Staff {
	/** The upper bars of the Bass Staff. */
	private List<UpperBar> upperBars;
	/** The middle bars of the Bass Staff. */
	private List<MiddleBar> middleBars;
	/** The lower bars of the Bass Staff. */
	private List<LowerBar> lowerBars;
	/** The upper bar display list of the Bass Staff. */
	private List<String> upperBarDisplayList;
	/** The middle bar display list of the Bass Staff. */
	private List<String> middleBarDisplayList;
	/** The lower bar display list of the Bass Staff. */
	private List<String> lowerBarDisplayList;
	/** The display of the Bass Staff. */
	private String display;

	/**
	 * Instantiates a new bass staff.
	 */
	public BassStaff() {
