...
/**
 * The Class TrebleStaff represents the Treble Staff.
 */
public class TrebleStaff implements Staff {
	/** The upper bars of the Treble Staff. */
	private List<UpperBar> upperBars;
	/** The middle bars of the Treble Staff. */
	private List<MiddleBar> middleBars;
	/** The lower bars of the Treble Staff. */
	private List<LowerBar> lowerBars;
	/** The upper bar display list of the Treble Staff. */
	private List<String> upperBarDisplayList;
	/** The middle bar display list of the Treble Staff. */
	private List<String> middleBarDisplayList;
	/** The lower bar display list of the Treble Staff. */
	private List<String> lowerBarDisplayList;
	/** The display of the Treble Staff. */
	private String display;

	/**
	 * Instantiates a new treble staff.
	 */
	public TrebleStaff() {
